...
public class HomeInfoDTO {
	...
	public HomeInfoDTO(String title, String location, String image1, String image2, String image3, String image4,
			String image5, String host, String info, String sideimage1, String sideInfo1, String sideimage2,
			String sideInfo2, String sideimage3, String sideInfo3) {
		super();
		this.title = title;
		this.location = location;
		this.image1 = image1;
	...
	public String toString() {
		return "HomeInfoDTO [title=" + title + ", location=" + location + ", image1=" + image1 + ", image2=" + image2
				...
				+ info + ", sideimage1=" + sideimage1 + ", sideInfo1=" + sideInfo1 + ", sideimage2=" + sideimage2
				+ ", sideInfo2=" + sideInfo2 + ", sideimage3=" + sideimage3 + ", sideInfo3=" + sideInfo3 + "]";
	}
