...
<body>
	...
	<section id=body>
		<div id=title>
			...
			<h5>⭐ <%=rating%> · <button type="submit" style="border-style:none; color:#5659C2" class="submit"><u>후기 <%=comentCount%>개</u></button> · Niseko, Abuta District, Hokkaido, 일본</h5>
			</form>
		</div>
		<div class=home>
			<div class=homeImgDiv>
				<section>
					<img alt="" src="images/home2/home2_1.png">
				</section>
				<section>
					<img alt="" src="images/home2/home2_2.png"> <img alt=""
						src="images/home2/home2_3.png">
				</section>
				<section>
					<img alt="" src="images/home2/home2_4.png"> <img alt=""
						src="images/home2	/home2_5.png">
				</section>
			</div>
			<div id=explanation>
				<div id=content>
					...
					<div class=info>
						<div>
							<img alt="" src="images/home1/location.png" style="height:50px;">
							<div>
								훌륭한 숙소 위치
						...
						<div>
							<img alt="" src="images/home1/key.png" style="height:50px;">
							<div>
								순조로운 체크인 과정
