...
<body>
	...
	<section id=body>
		<div id=title>
			...
			<h5>⭐ <%=rating%> · <button type="submit" style="border-style:none; color:#5659C2" class="submit"><u>후기 <%=comentCount%>개</u></button> · ❣ 슈퍼호스트 · 시모다, Shizuoka, 일본</h5>
			</form>
		</div>
		<div class=home>
			<div class=homeImgDiv>
				<section>
					<img alt="" src="images/home4/home4_1.png">
				</section>
				<section>
					<img alt="" src="images/home4/home4_2.png"> <img alt=""
						src="images/home4/home4_3.png">
				</section>
				<section>
					<img alt="" src="images/home4/home4_4.png"> <img alt=""
						src="images/home4/home4_5.png">
				</section>
			</div>
			<div id=explanation>
				<div id=content>
					<h3>Aquaholic 님이 호스팅하는 저택 전체</h3>
					<h5>최대 인원 6명 · 침실 3개 · 침대 6개 · 욕실 1개</h5>
					<hr>

					<div class=info>
						<div>
							<img alt="" src="images/home1/superhost1.png" style="height:40px; margin-top: 10px;">
							<div>
								Aquaholic님은 슈퍼호스트입니다
								<h6>슈퍼호스트는 풍부한 경험과 높은 평점을 자랑하며 게스트가 숙소에서 편안히 머무를 수 있도록 최선을 다하는 호스트입니다..</h6>
							</div>
						</div>
						<div>
							<img alt="" src="images/home1/location.png" style="height:40px; margin-top: 7px;">
							<div>
								훌륭한 숙소 위치
								<h6>최근 숙박한 게스트 중 100%가 위치에 별점 5점을 준 숙소입니다.</h6>
							</div>
						</div>
						<div>
							<img alt="" src="images/home1/key.png" style="height:40px; margin-top: 10px;">
							<div>
								순조로운 체크인 과정
